...
*/
    ...
    // 2. Set The Expected Data ( put, post, patch)
        ...
        Map<String,String> bookingdatesMap = obj.bookingdatesMethod("2021-09-09","2021-09-09");
        ...
        /*
        System.out.println("bookingdatesMap.get(\"checkout\") = " + bookingdatesMap.get("checkout"));
        System.out.println("((Map)((Map)(actualData.get(\"booking\"))).get(\"bookingdates\")).get(\"checkout\") = " +
